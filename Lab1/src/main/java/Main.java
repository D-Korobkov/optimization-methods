...
public class Main {
    public static void main(String[] args) {
        ...
        Search method2 = new GoldenRatioSearch(function, 0.1, 2.5, 0.000001);
        Search forbiddenMethod2 = new ForbiddenGoldenSearch(function, 0.1, 2.5, 0.000001);
        Search method3 = new FibonacciSearch(function, 0.1, 2.5, 0.0000001);
        Search method4 = new ParabolSearch(function,0.1, 2.5, 0.00000001);
